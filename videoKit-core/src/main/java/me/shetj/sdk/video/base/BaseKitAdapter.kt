...
//region 点击接口部分
typealias OnItemClickListener = (adapter: BaseKitAdapter<*>, view: View, position: Int) -> Unit

typealias OnItemLongClickListener = (adapter: BaseKitAdapter<*>, view: View, position: Int) -> Boolean


typealias OnItemChildClickListener = (adapter: BaseKitAdapter<*>, view: View, position: Int) -> Unit

typealias OnItemChildLongClickListener = (adapter: BaseKitAdapter<*>, view: View, position: Int) -> Boolean


abstract class BaseKitAdapter<T> @JvmOverloads constructor(
