...
import me.shetj.video.exoplayer.EXOVideoFactory

class Player3Activity : BaseBindingActivity<BaseViewModel, ActivityPlayer3Binding>() {
        ...
        mViewBinding.superVodPlayerView.apply {
            ...
            mViewBinding.btnUrl.setOnClickListener {
                ...
                VideoPlayerModel().apply {
                    val url =
                        "http://200024424.vod.myqcloud.com/200024424_709ae516bdf811e6ad39991f76a4df69.f20.mp4"
                    multiURLs = ArrayList<VideoPlayerModel.PlayerURL>().apply {
                        add(VideoPlayerModel.PlayerURL(url, "流畅"))
                        add(VideoPlayerModel.PlayerURL(url, "标清"))
                        add(VideoPlayerModel.PlayerURL(url, "高清"))
                    }
             ...
             * 设置全屏显示的window
             */
            mViewBinding.superVodPlayerView.setFullInWindow(this@Player3Activity.window)
            ...
            mViewBinding.btnShowSpeed.setOnClickListener {
                TimerConfigure.instance.showTimePick(this@Player3Activity)
            }
            ...
            mViewBinding.btnTestChangeUI.setOnClickListener {
                updateFloatView(EXOVideoFactory.getFloatView(this@Player3Activity)) // 设置悬浮窗
                updateFullScreenView(FullScreenPlayer(this@Player3Activity)) //更新全屏UI
                updateWindowView(WindowPlayer(this@Player3Activity))//更新小屏
            }
        }
    }
