...
class PointSeekBar : FrameLayout {
    ...
    private fun init(attrs: AttributeSet?) {
        ...
        var progressColor =
            ContextCompat.getColor(context, R.color.s_player_default_progress_color)
        var backgroundColor =
            ContextCompat.getColor(context, R.color.s_player_default_progress_background_color)
        if (attrs != null) {
