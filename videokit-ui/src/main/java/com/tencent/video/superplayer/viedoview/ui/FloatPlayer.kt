 ...
 * 2、关闭悬浮窗[.onClick]
 */
class FloatPlayer<T:View> : AbBaseUIPlayer, View.OnClickListener {
    /**
     * 获取悬浮窗中的视频播放view
     */
    var floatVideoView: VideoPlayerView<T>? = null// 悬浮窗中的视频播放view
        private set
    ...
    private fun initView(context: Context?) {
        ...
        floatVideoView = VideoPlayerView<T>().apply {
            //通过反射创建
        }
    ...
    override val playerMode: SuperPlayerDef.PlayerMode
        get() = SuperPlayerDef.PlayerMode.FLOAT
