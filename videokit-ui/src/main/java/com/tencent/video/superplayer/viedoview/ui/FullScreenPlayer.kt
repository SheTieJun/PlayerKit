...
class FullScreenPlayer :  AbBaseUIPlayer, View.OnClickListener, VodMoreView.Callback,
    ...
    private fun togglePlayState() {
        when (mCurrentPlayState) {
            SuperPlayerDef.PlayerState.PAUSE, SuperPlayerDef.PlayerState.END -> mControllerCallback?.onResume()
            SuperPlayerDef.PlayerState.PLAYING, SuperPlayerDef.PlayerState.LOADING -> mControllerCallback?.onPause()
        }
        show()
    }
